...
export default function PrivacyPage() {
  return (
    <div className="mx-auto max-w-3xl px-6 py-12">
      <h1 className="mb-2 font-serif text-4xl text-rjt-dark dark:text-rjt-cream">Privacybeleid</h1>
      <p className="mb-8 text-sm text-stone-400">Laatste update: april 2026</p>
      ...
      <div className="space-y-6">
        <div className="rounded-2xl bg-white p-8 shadow-sm dark:bg-stone-900/90">
          ...
          <p className="leading-relaxed text-stone-600 dark:text-stone-300">
            ...
            &apos;s-Hertogenbosch. Ons websiteadres is: https://renjitang.nl KvK-nummer: 94217262
          </p>
        </div>
