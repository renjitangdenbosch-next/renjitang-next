    ...
    <footer className="relative overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-6 py-16">
        <div className="grid grid-cols-1 gap-12 md:grid-cols-3">
          ...
          <div>
            ...
            />
            <p className="mb-4 font-lato text-sm text-[#1A2E1A]/80">Traditionele Chinese Geneeskunde</p>
            <div className="space-y-1 font-lato text-sm text-[#1A2E1A]/90">
          ...
          <div>
            ...
            <ul className="space-y-2 font-lato text-sm text-[#1A2E1A]/90">
              <li>
          ...
          <div>
            ...
            <div className="space-y-2 font-lato text-sm text-[#1A2E1A]/90">
              ...
              <div className="flex justify-between gap-8">
                <span>Maandag</span>
                <span className="text-[#1A2E1A]/70">Gesloten</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="relative z-10 border-t border-[#1A2E1A]/10 py-5">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-2 px-6 sm:flex-row">
          <p className="font-lato text-xs text-[#1A2E1A]/60">
            © {new Date().getFullYear()} Ren Ji Tang · KvK: 94217262
          </p>
          <div className="flex flex-wrap items-center justify-center gap-x-3 gap-y-1 font-lato text-xs text-[#1A2E1A]/60 sm:justify-end">
        ...
        <p className="mx-auto max-w-3xl px-6 pt-4 text-center font-lato text-xs leading-relaxed text-[#1A2E1A]/60">
